...
export default function RegisterForm() {
  ...
  const inputClass =
    "w-full rounded-xl border border-gray-300 pl-10 pr-4 py-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:scale-[1.02] transition-all duration-200";

  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 animate-fadeInUp [animation-delay:300ms]">
        <div>
      ...
      <div className="animate-fadeInUp [animation-delay:350ms]">
        ...
        <div className="phone-input-wrapper rounded-xl border border-gray-300 px-4 py-3 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:scale-[1.02] transition-all duration-200">
          <PhoneInput
            value={telephone}
